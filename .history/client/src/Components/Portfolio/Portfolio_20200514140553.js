            ...
            <h1>Here are some of my projects...</h1>
                <div className="projectBox"  >
                  ...
                  <p>A supper-club planning app for avid home chefs. Post events for others to RSVP to, or RSVP to other home chef's parties. 
                    Full stack application usses MySql, Sequellize ORM, Express.js, React Node.<br></br></p>
                </div>
                <div className="projectBox">
                  ...
                  <p>A local news site using jQuery, Node, Express.js server and REST APIs<br></br></p>
                </div>
                <div className="projectBox">
                  ...
                  <p>A burger logger made with MySQL, a custom ORM, Node, Express, and Handlebars.<br></br></p>
                </div>
                <div className="projectBox">
                  ...
                  <p>Simple work-day planner application. Uses HTML, CSS, jQuery and the browser's local storage.<br></br></p>  
                </div>
        </div>
        </>
    )
